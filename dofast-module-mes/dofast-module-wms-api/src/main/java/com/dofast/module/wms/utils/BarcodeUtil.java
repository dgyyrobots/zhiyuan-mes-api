...
import com.dofast.module.wms.Constant.Constant;
...
import static com.dofast.module.wms.enums.ErrorCodeConstants.BARCODE_NOT_NULL;
...
public class BarcodeUtil {
    ...
    public static File generateBarCode(String msg, String barCodeFormat, String path) {
        ...
        try {
            if(StrUtil.isEmpty(msg)){
                throw exception(BARCODE_NOT_NULL);
            }
            //检查父级目录是否存在，不存在先新建
             ...
             * 生成条码
             */
            if(Constant.QR_CODE.equals(barCodeFormat)){
                //生成二维码
     ...
     * 生成一维条形码
     * @param msg 条形码的内容
     * @param barCodeFormat 条形码格式 see {@link Constant}
    ...
    public static void generateLineCode(String msg,String barCodeFormat,String destFilePath) throws Exception {
        ...
        if(Constant.EAN_CODE.equals(barCodeFormat)){
            bean = new EAN13Bean();
        }else if(Constant.CODE39_CODE.equals(barCodeFormat)){
            bean = new Code39Bean();
        }else if(Constant.UPC_CODE.equals(barCodeFormat)){
            bean = new UPCABean();
        }else{
    ...
    public static void main(String[] args) {
        ...
        generateBarCode(msg, Constant.QR_CODE, path);
    }
}
