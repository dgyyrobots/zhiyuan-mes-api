...
/**
 * 出货检验单行 Base VO，提供给添加、修改、详细的子 VO 使用
 * 如果子 VO 存在差异的字段，请不要添加到这里，影响 Swagger 文档生成
 */
@Data
public class OqcLineBaseVO {

    @Schema(description = "检验单ID", requiredMode = Schema.RequiredMode.REQUIRED, example = "16040")
    @NotNull(message = "检验单ID不能为空")
    private Long oqcId;

    @Schema(description = "检测项ID", requiredMode = Schema.RequiredMode.REQUIRED, example = "15961")
