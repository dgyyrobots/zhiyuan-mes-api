 ...
 * @author 芋道源码
 */
@TableName("qms_ipqc_line")
@KeySequence("qms_ipqc_line_seq") // 用于 Oracle、PostgreSQL、Kingbase、DB2、H2 数据库的主键自增。如果是 MySQL 等数据库，可不写。
@Data
...
@NoArgsConstructor
@AllArgsConstructor
public class IpqcLineDO extends BaseDO {
