...
@Schema(description = "管理后台 - 来料检验单行 Excel 导出 Request VO，参数和 IqcLinePageReqVO 是一致的")
@Data
public class IqcLineExportReqVO {

    @Schema(description = "检验单ID", example = "23712")
    private Long iqcId;

    @Schema(description = "检测项ID", example = "22743")
