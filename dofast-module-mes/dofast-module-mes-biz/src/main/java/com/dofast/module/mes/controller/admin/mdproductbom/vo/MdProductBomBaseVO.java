...
public class MdProductBomBaseVO {
    ...
    @Schema(description = "物料产品ID", requiredMode = Schema.RequiredMode.REQUIRED, example = "21327")
    @NotNull(message = "物料产品ID不能为空")
    private Long itemId;

    @Schema(description = "BOM物料ID", requiredMode = Schema.RequiredMode.REQUIRED, example = "14923")
    ...
    @Schema(description = "BOM物料名称", requiredMode = Schema.RequiredMode.REQUIRED, example = "芋艿")
