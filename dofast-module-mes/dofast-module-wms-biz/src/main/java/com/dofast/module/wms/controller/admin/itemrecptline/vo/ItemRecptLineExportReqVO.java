...
@Schema(description = "管理后台 - 物料入库单行 Excel 导出 Request VO，参数和 ItemRecptLinePageReqVO 是一致的")
@Data
public class ItemRecptLineExportReqVO {

    @Schema(description = "入库单ID", example = "1658")
    private Long recptId;

    @Schema(description = "产品物料ID", example = "5826")
    private Long itemId;
