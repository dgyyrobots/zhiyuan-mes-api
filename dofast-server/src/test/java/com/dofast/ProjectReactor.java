...
public class ProjectReactor {
    ...
    private static final String GROUP_ID = "vip.huizhizao";
    private static final String ARTIFACT_ID = "dofast";
    private static final String PACKAGE_NAME = "com.dofast";
    private static final String TITLE = "惠智造数字化管理平台";
    ...
    public static void main(String[] args) {
        ...
        // === 配置，需要你手动修改 ===
        String groupIdNew = "vip.huizhizao";
        String artifactIdNew = "dofast";
        String packageNameNew = "com.dofast";
        String titleNew = "惠智造数字化管理平台";
