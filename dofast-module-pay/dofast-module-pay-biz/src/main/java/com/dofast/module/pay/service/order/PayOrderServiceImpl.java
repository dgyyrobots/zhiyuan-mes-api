...
import com.dofast.module.pay.controller.admin.order.vo.PayOrderSubmitReqVO;
import com.dofast.module.pay.controller.admin.order.vo.PayOrderSubmitRespVO;
...
import com.dofast.module.pay.dal.mysql.order.PayOrderExtensionMapper;
...
import com.dofast.module.pay.framework.pay.config.PayProperties;
...
public class PayOrderServiceImpl implements PayOrderService {
    ...
    @Override
    public PayOrderDO selectByMI(Long merchantOrderId) {
        return orderMapper.selectOne(new LambdaQueryWrapperX<PayOrderDO>()
                .eq(PayOrderDO::getMerchantOrderId, merchantOrderId));
    }
