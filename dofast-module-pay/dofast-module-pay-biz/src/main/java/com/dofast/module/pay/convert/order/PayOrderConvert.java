package com.dofast.module.pay.convert.order;
...
import com.dofast.module.pay.controller.admin.order.vo.*;
...
public interface PayOrderConvert {
    ...
    PayOrderSubmitRespVO convert(PayOrderDO order, com.dofast.framework.pay.core.client.dto.order.PayOrderRespDTO respDTO);
