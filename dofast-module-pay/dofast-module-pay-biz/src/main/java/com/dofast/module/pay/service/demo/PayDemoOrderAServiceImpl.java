...
import com.dofast.module.pay.dal.mysql.demo.PayDemoOrderMapper;
...
@Validated
@Slf4j
public class PayDemoOrderAServiceImpl implements PayDemoOrderService {
    ...
    public PayDemoOrderAServiceImpl() {
    ...
    public PageResult<PayDemoOrderDO> getDemoOrderPage(PageParam pageReqVO) {
        return payDemoOrderMapper.selectPage1(pageReqVO);
    }
    ...
    public void updateDemoOrderPaid(Long id, Long payOrderId) {
        ...
        int updateCount = payDemoOrderMapper.updateByIdAndPayed1(id, false,
