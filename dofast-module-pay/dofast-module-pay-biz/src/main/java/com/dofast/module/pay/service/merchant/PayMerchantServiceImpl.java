package com.dofast.module.pay.service.merchant;
...
import com.dofast.module.pay.convert.merchant.PayMerchantConvert;
...
import static com.dofast.module.pay.enums.ErrorCodeConstants.PAY_MERCHANT_EXIST_APP_CANT_DELETE;
import static com.dofast.module.pay.enums.ErrorCodeConstants.PAY_MERCHANT_NOT_EXISTS;
...
public class PayMerchantServiceImpl implements PayMerchantService {
    ...
    private void validateAppExists(Long id) {
        if (appMapper.selectCount1(id) > 0) {
