...
import com.dofast.module.member.convert.auth.AuthConvert;
...
import com.dofast.module.member.mq.producer.user.UserCreateProducer;
...
public class MemberUserServiceImpl implements MemberUserService {
    ...
    private MemberUserDO createUser(String mobile, String registerIp) {
        ...
        // 用户不存在，则进行创建
        return this.createUser1(mobile, registerIp);
    }
    private MemberUserDO createUser1(String mobile, String registerIp) {
        // 生成密码
    ...
    public boolean isPasswordMatch(String rawPassword, String encodedPassword) {
        return passwordEncoder.matches(rawPassword, this.encodePassword(encodedPassword));
    ...
    @Override
    public Long getUserList(MemberUserExportReqVO exportReqVO) {
    ...
    @Override
    public List<MemberUserDO> getUserList1(MemberUserExportReqVO exportReqVO) {
