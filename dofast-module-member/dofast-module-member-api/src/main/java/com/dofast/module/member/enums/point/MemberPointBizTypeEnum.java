package com.dofast.module.member.enums.point;
...
public enum MemberPointBizTypeEnum implements IntArrayValuable {
    ...
    ORDER_USE_CANCEL(16, "订单积分抵扣（整单取消）", "订单取消，退还 {} 积分", true), // ORDER_USE 的取消
    ORDER_USE_CANCEL_ITEM(15, "订单积分抵扣（单个退款）", "订单退款，退还 {} 积分", true), // ORDER_USE 的取消
