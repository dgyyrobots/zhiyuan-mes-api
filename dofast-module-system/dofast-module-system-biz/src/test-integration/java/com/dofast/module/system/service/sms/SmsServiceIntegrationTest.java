...
import com.dofast.framework.sms.config.DofastSmsAutoConfiguration;
import com.dofast.module.system.test.BaseDbAndRedisIntegrationTest;
import com.dofast.module.system.mq.consumer.sms.SmsSendConsumer;
...
// TODO @芋艿：需要迁移
@Import({DofastSmsAutoConfiguration.class,
