...
import com.dofast.module.system.controller.admin.user.vo.user.UserPageReqVO;
...
public interface AdminUserMapper extends BaseMapperX<AdminUserDO> {
    ...
    default List<AdminUserDO> selectAllByMobile(String mobile) {
        return selectList(new LambdaQueryWrapperX<AdminUserDO>()
                .likeIfPresent(AdminUserDO::getMobile, mobile)
                .orderByDesc(AdminUserDO::getId));
    }

    default AdminUserDO selectOneByTenantIdAndMoble(AuthNewLoginReqVO reqVO){
        return selectOne(new LambdaQueryWrapperX<AdminUserDO>()
                .eq(AdminUserDO::getMobile,reqVO.getMobile())
                .eq(TenantBaseDO::getTenantId,reqVO.getTenantId()));
    }
