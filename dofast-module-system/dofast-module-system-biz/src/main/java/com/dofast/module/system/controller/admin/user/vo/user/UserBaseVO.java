...
public class UserBaseVO {
    ...
    @Schema(description = "用户账号", requiredMode = Schema.RequiredMode.REQUIRED, example = "dofast")
    ...
    @Schema(description = "用户邮箱", example = "dofast@iocoder.cn")
