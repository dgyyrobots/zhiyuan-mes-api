...
public class AdminUserServiceImpl implements AdminUserService {
    ...
    @Value("${sys.user.init-password:dofastyuanma}")
    ...
    @Override
    public AdminUserDO getUserByTenantIdAndMoble(AuthNewLoginReqVO reqVO) {
        return userMapper.selectOneByTenantIdAndMoble(reqVO);
    }
