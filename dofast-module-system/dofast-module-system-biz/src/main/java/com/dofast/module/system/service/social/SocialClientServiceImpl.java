...
import com.dofast.framework.common.util.cache.CacheUtils;
import com.dofast.framework.common.util.http.HttpUtils;
import com.dofast.framework.social.core.DofastAuthRequestFactory;
import com.dofast.module.system.dal.dataobject.social.SocialClientDO;
import com.dofast.module.system.dal.mysql.social.SocialClientMapper;
...
import static com.dofast.module.system.enums.ErrorCodeConstants.SOCIAL_APP_WEIXIN_MINI_APP_PHONE_CODE_ERROR;
import static com.dofast.module.system.enums.ErrorCodeConstants.SOCIAL_USER_AUTH_FAILURE;
...
public class SocialClientServiceImpl implements SocialClientService {
    ...
    private AuthRequest buildAuthRequest(Integer socialType, Integer userType) {
        ...
        AuthRequest request = (AuthRequest) dofastAuthRequestFactory.get(SocialTypeEnum.valueOfType(socialType).getSource());
