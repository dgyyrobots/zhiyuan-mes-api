package com.dofast.module.system.convert.auth;
...
public interface AuthConvert {
    ...
    default AuthPermissionInfoRespVO convert(AdminUserDO user, List<RoleDO> roleList, List<MenuDO> menuList, TenantDO tenant) {
        return AuthPermissionInfoRespVO.builder()
            .user(AuthPermissionInfoRespVO.UserVO.builder().
                    id(user.getId()).nickname(user.getNickname())
                    .avatar(user.getAvatar())
                    .tenantname(tenant.getName())
                    .logo(tenant.getLogo()).build())
