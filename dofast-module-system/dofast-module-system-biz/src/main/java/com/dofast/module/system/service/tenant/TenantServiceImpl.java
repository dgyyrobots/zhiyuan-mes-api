package com.dofast.module.system.service.tenant;
...
import com.dofast.framework.tenant.config.TenantProperties;
...
import com.dofast.module.system.controller.admin.permission.vo.role.RoleCreateReqVO;
import com.dofast.module.system.controller.admin.tenant.vo.tenant.TenantCreateReqVO;
import com.dofast.module.system.controller.admin.tenant.vo.tenant.TenantExportReqVO;
import com.dofast.module.system.controller.admin.tenant.vo.tenant.TenantPageReqVO;
...
import com.dofast.module.system.dal.mysql.tenant.TenantMapper;
import com.dofast.module.system.enums.permission.RoleCodeEnum;
import com.dofast.module.system.enums.permission.RoleTypeEnum;
import com.dofast.module.system.service.permission.MenuService;
...
import com.dofast.module.system.service.tenant.handler.TenantInfoHandler;
import com.dofast.module.system.service.tenant.handler.TenantMenuHandler;
...
public class TenantServiceImpl implements TenantService {
    ...
    @Autowired(required = false) // 由于 dofast.tenant.enable 配置项，可以关闭多租户的功能，所以这里只能不强制注入
    ...
    @Override
    public TenantDO getTenantByDomainName(String domainName) {
        return tenantMapper.selectByDomainName(domainName);
    }
