...
CREATE TABLE IF NOT EXISTS "sys_auto_code_part" (
    "partId" bigint NOT NULL GENERATED BY DEFAULT AS IDENTITY,
    ...
    "date_format" varchar,
    "input_character" varchar,
    "fix_character" varchar,
    "seria_start_no" int,
    "seria_step" int,
    "seria_now_no" int,
    "cycle_flag" varchar,
    "cycle_method" varchar,
    "remark" varchar,
    "attr1" varchar,
    "attr2" varchar,
    "attr3" int,
...
CREATE TABLE IF NOT EXISTS "sys_auto_code_result" (
  "codeId" bigint NOT NULL GENERATED BY DEFAULT AS IDENTITY,
  "rule_id" bigint NOT NULL,
  "gen_date" varchar NOT NULL,
  "gen_index" int,
  "last_result" varchar,
  "last_serial_no" int,
  "last_input_char" varchar,
  "remark" varchar,
  "attr1" varchar,
  "attr2" varchar,
  "attr3" int,
...
CREATE TABLE IF NOT EXISTS "sys_auto_code_rule" (
    "ruleId" bigint NOT NULL GENERATED BY DEFAULT AS IDENTITY,
    "rule_code" varchar NOT NULL,
    "rule_name" varchar NOT NULL,
    "rule_desc" varchar,
    "max_length" int,
    "is_padded" varchar NOT NULL,
    "padded_char" varchar,
    "padded_method" varchar,
    "enable_flag" varchar NOT NULL,
    "remark" varchar,
    "attr1" varchar,
    "attr2" varchar,
    "attr3" int,
