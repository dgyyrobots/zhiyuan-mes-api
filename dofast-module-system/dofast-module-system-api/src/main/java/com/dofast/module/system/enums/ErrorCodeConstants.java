package com.dofast.module.system.enums;
...
public interface ErrorCodeConstants {
   ...
   // === AUTH 模块 1002000000 ===
	...
	ErrorCode PAD_AUTH_LOGIN_PARAM_NOT_EXISTS = new ErrorCode(1002000008, "登录参数不能为空");
	ErrorCode PAD_AUTH_LOGIN_TYPE_NOT_EXISTS = new ErrorCode(1002000009, "登录方式不能为空");
	ErrorCode PAD_AUTH_LOGIN_NAME_NOT_EXISTS = new ErrorCode(1002000010, "登录名不能为空");
	ErrorCode PAD_AUTH_LOGIN_PASSWORD_NOT_EXISTS = new ErrorCode(1002000011, "密码不能为空");
	ErrorCode PAD_AUTH_LOGIN_NOT_EXISTS = new ErrorCode(1002000012, "账号不存在");
	...
	//	=== 物流公司 1002009000 ===
	ErrorCode EXPRESS_COMPANY_TEMPLATE_NOT_EXISTS = new ErrorCode(1002009001, "系统物流公司不存在");
	...
	// === 系统物流公司 1030001000 ===
	ErrorCode EXPRESS_COMPANY_NOT_EXISTS = new ErrorCode(1030001000, "系统物流公司不存在");
	
	// === 电子面单 1030002000 ===
	ErrorCode EXPRESS_ELECTRONICSHEET_NOT_EXISTS = new ErrorCode(1030002000, "电子面单不存在");
	
	// === 运费模板 1030003000 ===
	ErrorCode EXPRESS_TEMPLATE_NOT_EXISTS = new ErrorCode(1030003000, "运费模板不存在");
	
	// === 运费模板细节 1030004000 ===
	ErrorCode EXPRESS_TEMPLATE_ITEM_NOT_EXISTS = new ErrorCode(1030004000, "运费模板细节不存在");

    // === 字段 1025001000 ===
    ErrorCode FORM_ITEM_NOT_EXISTS = new ErrorCode(1025001000, "字段不存在");
    
    // === 系统表单 1025002000 ===
    ErrorCode FORM_NOT_EXISTS = new ErrorCode(1025002000, "系统表单不存在");

	// === 租户配置 1025003000 ===
	ErrorCode CONFIG_NOT_EXISTS = new ErrorCode(1025003000, "租户配置不存在");

	ErrorCode CONFIG_IS_EXISTS = new ErrorCode(1025005000, "租户配置已存在");
