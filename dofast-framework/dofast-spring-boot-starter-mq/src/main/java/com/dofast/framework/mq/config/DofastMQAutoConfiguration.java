package com.dofast.framework.mq.config;

import cn.hutool.core.map.MapUtil;
import cn.hutool.core.util.StrUtil;
import cn.hutool.system.SystemUtil;
import com.dofast.framework.common.enums.DocumentEnum;
import com.dofast.framework.mq.core.RedisMQTemplate;
import com.dofast.framework.mq.core.interceptor.RedisMessageInterceptor;
...
import com.dofast.framework.mq.job.RedisPendingMessageResendJob;
...
public class DofastMQAutoConfiguration {
    ...
    @ConditionalOnProperty(prefix = "dofast.mq.redis.pubsub", value = "enable", matchIfMissing = true) // 允许使用 dofast.mq.redis.pubsub.enable=false 禁用多租户
    ...
    @ConditionalOnProperty(prefix = "dofast.mq.redis.stream", value = "enable", matchIfMissing = true) // 允许使用 dofast.mq.redis.stream.enable=false 禁用多租户
