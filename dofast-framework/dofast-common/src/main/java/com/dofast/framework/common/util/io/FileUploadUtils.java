...
import com.dofast.framework.common.util.uuid.Seq;
...
public class FileUploadUtils {
    public static final String profile ="D:/source_code/j2eeworkspace/ktg-mes/upload";
     ...
     * 默认上传的地址
     */
    private static String defaultBaseDir = "D:/source_code/j2eeworkspace/ktg-mes/upload";
    ...
    public static final String upload(String baseDir, MultipartFile file, String[] allowedExtension)
        ...
        {
            throw new Exception("upload.filename.exceed.length "+ FileUploadUtils.DEFAULT_FILE_NAME_LENGTH);
        }
    ...
    public static final String getPathFileName(String uploadDir, String fileName) throws IOException
    {
        ...
        return profile_prefix + "/" + currentDir + "/" + fileName;
    }
    ...
    public static final void assertAllowed(MultipartFile file, String[] allowedExtension)
        ...
        {
            throw new Exception("upload.exceed.maxSize"+(DEFAULT_MAX_SIZE / 1024 / 1024));
        }
        ...
        {
            throw new Exception(allowedExtension+" "+extension+" "+fileName);
        }
