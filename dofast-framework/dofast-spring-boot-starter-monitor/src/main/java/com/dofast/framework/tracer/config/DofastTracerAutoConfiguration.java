package com.dofast.framework.tracer.config;

import com.dofast.framework.common.enums.WebFilterOrderEnum;
import com.dofast.framework.tracer.core.aop.BizTraceAspect;
import com.dofast.framework.tracer.core.filter.TraceFilter;
...
@ConditionalOnProperty(prefix = "dofast.tracer", value = "enable", matchIfMissing = true)
public class DofastTracerAutoConfiguration {
