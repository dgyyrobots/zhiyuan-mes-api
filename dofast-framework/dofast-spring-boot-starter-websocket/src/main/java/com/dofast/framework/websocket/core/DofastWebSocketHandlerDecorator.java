package com.dofast.framework.websocket.core;
...
public class DofastWebSocketHandlerDecorator extends WebSocketHandlerDecorator {
    public DofastWebSocketHandlerDecorator(WebSocketHandler delegate) {
        super(delegate);
    }
