 ...
 */
@AutoConfiguration
// 允许使用 dofast.websocket.enable=false 禁用websocket
@ConditionalOnProperty(prefix = "dofast.websocket", value = "enable", matchIfMissing = true)
@EnableConfigurationProperties(WebSocketProperties.class)
public class DofastWebSocketAutoConfiguration {
    @Bean
