package com.dofast.module.product.service.category;
...
import com.dofast.module.product.convert.category.ProductCategoryConvert;
import com.dofast.module.product.dal.dataobject.category.ProductCategoryDO;
import com.dofast.module.product.dal.mysql.category.ProductCategoryMapper;
...
import static com.dofast.module.product.enums.ErrorCodeConstants.CATEGORY_DISABLED;
import static com.dofast.module.product.enums.ErrorCodeConstants.CATEGORY_NOT_EXISTS;
import static com.dofast.module.product.dal.dataobject.category.ProductCategoryDO.PARENT_ID_NULL;
...
public class ProductCategoryServiceImpl implements ProductCategoryService {
    ...
    public void validateCategory(Long id) {
        ...
        if (Objects.equals(category.getStatus(), CommonStatusEnum.DISABLE.getStatus())) {
            throw ServiceExceptionUtil.exception(CATEGORY_DISABLED, category.getName());
        }
    }
