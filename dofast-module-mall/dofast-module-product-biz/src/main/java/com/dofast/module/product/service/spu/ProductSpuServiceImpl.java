package com.dofast.module.product.service.spu;
...
import com.dofast.module.product.dal.mysql.spu.ProductSpuMapper;
import com.dofast.module.product.enums.ErrorCodeConstants;
import com.dofast.module.product.enums.spu.ProductSpuStatusEnum;

import com.dofast.module.product.service.brand.ProductBrandService;
import com.dofast.module.product.service.category.ProductCategoryService;
...
import static com.dofast.module.product.dal.dataobject.category.ProductCategoryDO.CATEGORY_LEVEL;
...
//        spu.setBarCode(getMinValue(skus, ProductSkuCreateOrUpdateReqVO::getBarCode));
    ...
    private void validateSpuExists(Long id) {
        if (productSpuMapper.selectById(id) == null) {
            throw ServiceExceptionUtil.exception(SPU_NOT_EXISTS);
        }
    }
