package com.dofast.module.promotion.service.seckill;
...
import com.dofast.module.promotion.controller.admin.seckill.vo.activity.SeckillActivityCreateReqVO;
import com.dofast.module.promotion.controller.admin.seckill.vo.activity.SeckillActivityPageReqVO;
import com.dofast.module.promotion.controller.admin.seckill.vo.activity.SeckillActivityUpdateReqVO;
import com.dofast.module.promotion.controller.admin.seckill.vo.product.SeckillProductBaseVO;
import com.dofast.module.promotion.controller.app.seckill.vo.activity.AppSeckillActivityPageReqVO;
import com.dofast.module.promotion.convert.seckill.seckillactivity.SeckillActivityConvert;
...
import com.dofast.module.promotion.dal.dataobject.seckill.SeckillProductDO;
import com.dofast.module.promotion.dal.mysql.seckill.seckillactivity.SeckillActivityMapper;
import com.dofast.module.promotion.dal.mysql.seckill.seckillactivity.SeckillProductMapper;
...
import static com.dofast.framework.common.util.date.LocalDateTimeUtils.isBetween;
...
public class SeckillActivityServiceImpl implements SeckillActivityService {
    ...
    private void validateProductExists(Long spuId, List<SeckillProductBaseVO> products) {
        ...
        // 2. 校验商品 sku 都存在
        Map<Long, ProductSkuRespDTO> skuMap = convertMap(productSkuApi.getSkuList1(singletonList(spuId)),
