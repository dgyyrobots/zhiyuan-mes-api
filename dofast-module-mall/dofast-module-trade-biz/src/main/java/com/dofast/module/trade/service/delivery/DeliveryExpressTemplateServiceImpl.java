...
import com.dofast.module.trade.controller.admin.delivery.vo.expresstemplate.*;
import com.dofast.module.trade.dal.dataobject.delivery.DeliveryExpressTemplateChargeDO;
import com.dofast.module.trade.dal.dataobject.delivery.DeliveryExpressTemplateDO;
import com.dofast.module.trade.dal.dataobject.delivery.DeliveryExpressTemplateFreeDO;
import com.dofast.module.trade.dal.mysql.delivery.DeliveryExpressTemplateChargeMapper;
import com.dofast.module.trade.dal.mysql.delivery.DeliveryExpressTemplateFreeMapper;
import com.dofast.module.trade.dal.mysql.delivery.DeliveryExpressTemplateMapper;
import com.dofast.module.trade.service.delivery.bo.DeliveryExpressTemplateRespBO;
...
import static com.dofast.module.trade.convert.delivery.DeliveryExpressTemplateConvert.INSTANCE;
import static com.dofast.module.trade.enums.ErrorCodeConstants.EXPRESS_TEMPLATE_NAME_DUPLICATE;
import static com.dofast.module.trade.enums.ErrorCodeConstants.EXPRESS_TEMPLATE_NOT_EXISTS;
...
public class DeliveryExpressTemplateServiceImpl implements DeliveryExpressTemplateService {
    ...
    @Resource
    private DeliveryExpressTemplateMapper deliveryExpressTemplateMapper;
    @Resource
    ...
    public Long createDeliveryExpressTemplate(DeliveryExpressTemplateCreateReqVO createReqVO) {
        ...
        deliveryExpressTemplateMapper.insert(template);
        // 插入运费模板计费表
    ...
    public void updateDeliveryExpressTemplate(DeliveryExpressTemplateUpdateReqVO updateReqVO) {
        ...
        deliveryExpressTemplateMapper.updateById(updateObj);
    }
    ...
    public void deleteDeliveryExpressTemplate(Long id) {
        ...
        // 删除主表
        deliveryExpressTemplateMapper.deleteById(id);
        // 删除运费从表
    ...
    private void validateTemplateNameUnique(String name, Long id) {
        DeliveryExpressTemplateDO template = deliveryExpressTemplateMapper.selectByName(name);
        if (template == null) {
            return;
        }
        // 如果 id 为空
    ...
    private void validateDeliveryExpressTemplateExists(Long id) {
        if (deliveryExpressTemplateMapper.selectById(id) == null) {
    ...
    public DeliveryExpressTemplateDetailRespVO getDeliveryExpressTemplate(Long id) {
        ...
        DeliveryExpressTemplateDO template = deliveryExpressTemplateMapper.selectById(id);
    ...
    public Map<Long, DeliveryExpressTemplateRespBO> getExpressTemplateMapByIdsAndArea(Collection<Long> ids, Integer areaId) {
        ...
        List<DeliveryExpressTemplateDO> templateList = deliveryExpressTemplateMapper.selectBatchIds(ids);
