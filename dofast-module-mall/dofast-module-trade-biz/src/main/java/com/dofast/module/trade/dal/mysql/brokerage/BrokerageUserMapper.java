package com.dofast.module.trade.dal.mysql.brokerage;

import cn.hutool.core.convert.Convert;
import cn.hutool.core.lang.Assert;
import com.dofast.framework.common.pojo.PageResult;
import com.dofast.framework.common.pojo.SortingField;
...
public interface BrokerageUserMapper extends BaseMapperX<BrokerageUserDO> {
    ...
    default BrokerageUserDO getOneByBindUserId(Long userId){
        return selectOne(new LambdaQueryWrapperX<BrokerageUserDO>()
