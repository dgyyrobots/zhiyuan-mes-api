...
public class TradeOrderBaseVO {
    ...
    @Schema(description = "渠道订单编号", requiredMode = Schema.RequiredMode.REQUIRED, example = "1024")
    private String channelOrderId;

    @Schema(description = "订单流水号", requiredMode = Schema.RequiredMode.REQUIRED, example = "1146347329394184195")
    private String no;

    @Schema(description = "渠道订单流水号", requiredMode = Schema.RequiredMode.REQUIRED, example = "1024")
...
//    @Schema(description = "业务员的id", example = "你猜一下")
//    private Long memberId;
//
//    @Schema(description = "业务员名字", example = "你猜一下")
