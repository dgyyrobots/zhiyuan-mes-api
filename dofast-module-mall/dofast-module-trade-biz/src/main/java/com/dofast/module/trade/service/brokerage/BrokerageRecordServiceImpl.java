...
import com.dofast.module.trade.controller.admin.brokerage.vo.record.BrokerageRecordPageReqVO;
import com.dofast.module.trade.controller.app.brokerage.vo.record.AppBrokerageProductPriceRespVO;
import com.dofast.module.trade.controller.app.brokerage.vo.user.AppBrokerageUserRankByPriceRespVO;
...
import com.dofast.module.trade.dal.mysql.brokerage.BrokerageRecordMapper;
...
import static com.dofast.framework.common.util.collection.CollectionUtils.getMaxValue;
import static com.dofast.framework.common.util.collection.CollectionUtils.getMinValue;
import static com.dofast.framework.web.core.util.WebFrameworkUtils.getLoginUserId;
import static com.dofast.module.trade.enums.ErrorCodeConstants.BROKERAGE_WITHDRAW_USER_BALANCE_NOT_ENOUGH;
...
public class BrokerageRecordServiceImpl implements BrokerageRecordService {
    ...
    public AppBrokerageProductPriceRespVO calculateProductBrokeragePrice(Long userId, Long spuId) {
        ...
        List<ProductSkuRespDTO> skuList = productSkuApi.getSkuList1(ListUtil.of(spuId));
