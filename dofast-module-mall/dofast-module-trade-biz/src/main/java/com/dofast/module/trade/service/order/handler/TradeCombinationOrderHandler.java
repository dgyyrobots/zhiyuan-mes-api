package com.dofast.module.trade.service.order.handler;

import cn.hutool.core.lang.Assert;
import com.dofast.module.promotion.api.combination.CombinationRecordApi;
...
import static com.dofast.module.trade.enums.ErrorCodeConstants.ORDER_CREATE_FAIL_EXIST_UNPAID;
import static com.dofast.module.trade.enums.ErrorCodeConstants.ORDER_DELIVERY_FAIL_COMBINATION_RECORD_STATUS_NOT_SUCCESS;
...
public class TradeCombinationOrderHandler implements TradeOrderHandler {
    ...
    public void afterPayOrder(TradeOrderDO order, List<TradeOrderItemDO> orderItems) {
        ...
        CombinationRecordCreateRespDTO combinationRecord = combinationRecordApi.createCombinationRecord1(TradeOrderConvert.INSTANCE.convert(order, item));
