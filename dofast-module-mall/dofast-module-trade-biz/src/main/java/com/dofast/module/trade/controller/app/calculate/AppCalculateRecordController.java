...
@Validated
public class AppCalculateRecordController {
    ...
    @PreAuthenticated
    public CommonResult<Long> createCalculateRecord(@RequestBody CalculateRecordCreateReqVO createReqVO) {
    ...
    @PreAuthenticated
    public CommonResult<Boolean> updateCalculateRecord(@RequestBody CalculateRecordUpdateReqVO updateReqVO) {
    ...
    @PreAuthenticated
    public CommonResult<PageResult<CalculateRecordRespVO>> getCalculateRecordPage(CalculateRecordPageReqVO pageVO) {
    ...
    public void exportCalculateRecordExcel(CalculateRecordExportReqVO exportReqVO,
