...
import com.dofast.module.trade.controller.admin.order.vo.TradeOrderSummaryRespVO;
...
import com.dofast.module.trade.dal.redis.RedisKeyConstants;
...
import com.dofast.module.trade.framework.delivery.core.client.ExpressClientFactory;
...
import static com.dofast.module.trade.enums.ErrorCodeConstants.EXPRESS_NOT_EXISTS;
import static com.dofast.module.trade.enums.ErrorCodeConstants.ORDER_NOT_FOUND;
...
public class TradeOrderQueryServiceImpl implements TradeOrderQueryService {
    ...
    private List<ExpressTrackRespDTO> getExpressTrackList(TradeOrderDO order) {
        ...
        // 查询物流公司
        DeliveryExpressDO express = deliveryExpressService.validateDeliveryExpress(order.getLogisticsId());
        if (express == null) {
