...
CREATE TABLE IF NOT EXISTS "diy_template_category" (
   "id" int NOT NULL GENERATED BY DEFAULT AS IDENTITY,
   "name" varchar NOT NULL,
   "pid" int NOT NULL,
   "level" int NOT NULL,
...
CREATE TABLE IF NOT EXISTS "diy_template_goods" (
    "goodsId" int NOT NULL GENERATED BY DEFAULT AS IDENTITY,
...
CREATE TABLE IF NOT EXISTS "diy_view_tenant" (
     "id" int NOT NULL GENERATED BY DEFAULT AS IDENTITY,
...
CREATE TABLE IF NOT EXISTS "diy_template_goods_item" (
     "goodsItemId" int NOT NULL GENERATED BY DEFAULT AS IDENTITY,
...
CREATE TABLE IF NOT EXISTS "diy_view_util" (
   "id" int NOT NULL GENERATED BY DEFAULT AS IDENTITY,
   "name" varchar NOT NULL,
   "title" varchar NOT NULL,
   "type" varchar NOT NULL,
   ...
   "addon_name" varchar NOT NULL,
   "sort" int NOT NULL,
   "support_diy_view" varchar NOT NULL,
...
CREATE TABLE IF NOT EXISTS "diy_theme" (
   "id" int NOT NULL GENERATED BY DEFAULT AS IDENTITY,
   "title" varchar NOT NULL,
   "name" varchar NOT NULL,
   "addon_name" varchar NOT NULL,
   "main_color" varchar NOT NULL,
   "aux_color" varchar NOT NULL,
   "preview" varchar NOT NULL,
   "color_img" varchar NOT NULL,
   "value" varchar,
   "creator" varchar DEFAULT '',
   "create_time" datetime NOT NULL DEFAULT CURRENT_TIMESTAMP,
   "updater" varchar DEFAULT '',
