package com.dofast.module.infra.enums;
...
public interface ErrorCodeConstants {
    ...
    // === 地址信息配置 1001008000 ===
    ErrorCode ADDRESS_SOURCE_ERROR = new ErrorCode(1001008000, "地址解析错误");

    // === 自定义模板页面类型 1001009000 ===
    ErrorCode DIY_TEMPLATE_NOT_EXISTS = new ErrorCode(1001009000, "自定义模板页面类型不存在");

    // === 自定义模板分类 1001010000 ===
    ErrorCode DIY_TEMPLATE_CATEGORY_NOT_EXISTS = new ErrorCode(1001010000, "自定义模板分类不存在");

    // === 自定义模板组 1001011000 ===
    ErrorCode DIY_TEMPLATE_GOODS_NOT_EXISTS = new ErrorCode(1001011000, "自定义模板组不存在");

    // === 租户自定义模板 1001012000 ===
    ErrorCode DIY_VIEW_TENANT_NOT_EXISTS = new ErrorCode(1001012000, "租户自定义模板不存在");

    // === 模板组页面 1001013000 ===
    ErrorCode DIY_TEMPLATE_GOODS_ITEM_NOT_EXISTS = new ErrorCode(1001013000, "模板组页面不存在");

    // === 自定义模板组件 1001014000 ===
    ErrorCode DIY_VIEW_UTIL_NOT_EXISTS = new ErrorCode(1001014000, "自定义模板组件不存在");

    // === 自定义模板主题风格配色 1001015000 ===
    ErrorCode DIY_THEME_NOT_EXISTS = new ErrorCode(1001015000, "自定义模板主题风格配色不存在");
