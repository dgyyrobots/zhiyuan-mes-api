...
public interface DeviceGroupService {
     ...
     * @return 编号
     */
    Long createDeviceGroup(@Valid DeviceGroupCreateReqVO createReqVO);
     ...
     */
    void updateDeviceGroup(@Valid DeviceGroupUpdateReqVO updateReqVO);
     ...
     * @return 设备分组列表
     */
    List<DeviceGroupDO> getDeviceGroupList(Collection<Long> ids);
     ...
     * @return 设备分组列表
     */
    List<DeviceGroupDO> getDeviceGroupList(DeviceGroupExportReqVO exportReqVO);
