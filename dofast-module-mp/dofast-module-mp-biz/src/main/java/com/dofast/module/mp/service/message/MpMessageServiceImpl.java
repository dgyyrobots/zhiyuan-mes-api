package com.dofast.module.mp.service.message;

import cn.hutool.core.lang.Assert;
import cn.hutool.core.util.StrUtil;
import com.dofast.framework.common.pojo.PageResult;
import com.dofast.module.mp.controller.admin.message.vo.message.MpMessagePageReqVO;
import com.dofast.module.mp.controller.admin.message.vo.message.MpMessageSendReqVO;
import com.dofast.module.mp.convert.message.MpMessageConvert;
import com.dofast.module.mp.dal.dataobject.account.MpAccountDO;
import com.dofast.module.mp.dal.dataobject.message.MpMessageDO;
import com.dofast.module.mp.dal.dataobject.user.MpUserDO;
import com.dofast.module.mp.dal.mysql.message.MpMessageMapper;
import com.dofast.module.mp.enums.message.MpMessageSendFromEnum;
import com.dofast.module.mp.framework.mp.core.MpServiceFactory;
import com.dofast.module.mp.framework.mp.core.util.MpUtils;
import com.dofast.module.mp.service.account.MpAccountService;
import com.dofast.module.mp.service.material.MpMaterialService;
import com.dofast.module.mp.service.message.bo.MpMessageSendOutReqBO;
import com.dofast.module.mp.service.user.MpUserService;
...
import static com.dofast.module.mp.enums.ErrorCodeConstants.MESSAGE_SEND_FAIL;
